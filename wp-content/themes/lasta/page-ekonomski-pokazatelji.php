<?php
/* 
Template Name: Ekonomski pokazatelji  
 */
            ...
            <div class="row">
                ...
                <div class="col-lg-12 about-us pt-4" id="ekon-tabs" data-aos="fade">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active text-white rounded-0  border-0 px-4" id="ekon-tab" data-toggle="tab" href="#ekon" role="tab" aria-controls="ekon" aria-selected="true">
                                Ekonomski pokazatelji:
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white rounded-0  border-0 px-4" id="finan-tab" data-toggle="tab" href="#finan" role="tab" aria-controls="finan" aria-selected="false">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active px-4 py-3 animated fadeIn faster" id="ekon" role="tabpanel" aria-labelledby="ekon-tab">
                            ...
                            <a class="text-white" href="<?php the_field('file-doc'); ?>" target="_blank">
                        ...
                        <div class="tab-pane fade px-4 py-3 animated fadeIn faster" id="finan" role="tabpanel" aria-labelledby="finan-tab">
                        <?php  $docs_query = new WP_Query( array(
                                    'post_type' => 'dokumenta',
                                    'posts_per_page' => -1,
                                    'tax_query' => array(
