...
$i++;
$cfg['Servers'][$i]['host'] 			= 'db1.paukhost.com:3306';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= 'tH%94P=;LK5<#^k53r*sq(HB:bMQ,0_q' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_8K2VQNcbFst0rmaeTAOwDzG/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
